...
- [Handson: Confusion Matrix and Metrics](./confusionmatrixandmetrics.py)
- [Handson: SMOTE for Balancing Dataset](./smoteforbalancingdataset.py)
- [Handson: Hyperparameter Tuning using Grid Search](./hyperparametertuning.py)
- [Handson: Comparing Models](./comparingmodels.py)
